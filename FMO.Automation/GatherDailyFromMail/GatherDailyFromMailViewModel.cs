...
public partial class GatherDailyFromMailViewModel : MissionViewModel<GatherDailyFromMailMission>
{
    [ObservableProperty]
    ...
    public GatherDailyFromMailViewModel(GatherDailyFromMailMission m) : base(m)
    {
        Title = "净值更新";
